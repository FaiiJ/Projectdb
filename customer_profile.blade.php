            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-12">
                    <div class="row">
                        <div class="col-12" style="text-align: center; margin-bottom: 10px;">
                            <button type="button" class="btn btn-outline-info btn-lg">PROFILE</button>
                        </div>
                        <div class="col-12" style="text-align: center;">
                            <button type="button" class="btn btn-outline-info">ORDER HISTORY</button>
                        </div>
                    </div>
                </div>
                <!--PROFILE-->
                <div class="col-md-8 col-sm-12">
                    <form action="/action_page.php">
                        ...
                        <div class="row justify-content-center">
                            <a href="/customer_login"><button type="button" class="btn btn-success">SAVE</button></a>
                        </div>
                    </form>
                </div>
            </div>
